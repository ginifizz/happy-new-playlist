...
export default function TapeSection({
  ...
  return (
    <div ref={container} className='w-full h-screen relative overflow-hidden'>
      <div className='container relative h-full flex flex-col-reverse gap-12 landscape:flex-row items-center landscape:gap-6 mx-auto lg:pt-20 pb-20'>
        <div
          ref={textElement}
          className='relative flex flex-col flex-1 gap-1 pb-4 landscape:pb-0'
        >
          <div className='text-red'>
            <Arrows />
          </div>
          <div className='text-lg lg:text-2xl text-brown font-black'>
            <span>{subtitle}</span>
          ...
          <div
            className='font-title text-4xl lg:text-7xl text-red uppercase'
            dangerouslySetInnerHTML={{ __html: title }}
          />
          <div
            className='text-xs lg:text-lg mt-2'
          ...
          <div className='flex flex-row flex-wrap gap-4 text-beige my-4'>
            <button
              ...
              className={clsx(
                'flex flex-row items-center gap-2 bg-red py-1 px-2 lg:py-2 lg:px-3 rounded-3xl transition-all hover:brightness-125',
            ...
            >
              ...
              <span className='hidden lg:block text-sm lg:text-base uppercase font-black'>
            ...
            <a
              ...
              className='flex flex-row items-center gap-2 bg-green py-1 px-2 lg:py-2 lg:px-3 rounded-3xl transition-all hover:brightness-125'
            >
              <svg
                xmlns='http://www.w3.org/2000/svg'
                x='0px'
              ...
              <span className='text-xs lg:text-base uppercase font-black'>
                {dictionary.spotify}
              </span>
            </a>
          </div>
          <button
            className={clsx(
              'flex flex-row gap-2 mt-6 font-extrabold text-sm lg:text-base text-brown uppercase',
        ...
        <div
          ref={tapeElement}
          className='flex items-center relative h-auto w-2/3 landscape:w-2/5 landscape:lg:w-1/2 landscape:h-full mt-24 landscape:mt-0'
        >
          <Tape
            title={title}
            subtitle={subtitle}
            ...
            className={clsx(
              'landscape:absolute landscape:left-1/2 landscape:top-1/2 landscape:-translate-x-1/2 landscape:-translate-y-1/2 drop-shadow-floating w-[90%]',
              rotateClassName
            )}
          />
        </div>
